...
Scenario: Composite Rating for a Product
  Given that a product exists called "Nutcracker Hillary"
  And that the product has a review with a rating of 3 stars
  And that the product has a review with a rating of 5 stars
  When I visit the product's page
